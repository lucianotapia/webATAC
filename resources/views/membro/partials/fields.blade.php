<tr>    
    ...
    <td class="text-center">
        ...
        <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#deleteModal" data-id_col="{{ $membro->CodMembro }}" data-nome="{{ $membro->nome }}"><i class="fa fa-trash"></i> Excluir</button>
    </td>   
</tr>        
